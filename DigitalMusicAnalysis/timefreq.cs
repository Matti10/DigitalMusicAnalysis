...
namespace DigitalMusicAnalysis
{
    public class timefreq
    {
        ...
        float[][] stft(Complex[] x, int wSamp)
        {
            ...
            //could parralelize the fft call here, or just pararlelize the func itself (call may be better be unsire RE parralell rec)
        ...
        //OLD FFT
        //this recursive boi takes up ALOT of the time (approx 50%)
